...
<!--
  ACTION REQUIRED: Explain how this feature fits the easy-bpmn constitution.
  Use N/A only when the feature truly does not touch that concern, and include
...
**Runtime Idempotency Impact**: [How duplicate callbacks, duplicate events,
retries, and replay are handled, or N/A with rationale]

**Receive Task Correlation Impact**: [Message name, correlation key, eligible
waiting instance rules, and duplicate/late/ambiguous event behavior, or N/A with
rationale]

**Audit and Operator Visibility Impact**: [History entries, visible status,
current BPMN element, variables, and actionable errors, or N/A with rationale]

**Demo Flow Impact**: [How this supports upload -> publish -> start -> service
task -> receive message -> complete -> history, or N/A with rationale]
